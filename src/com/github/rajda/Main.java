...
public class Main {
    private static final int optimizationCyclesNumber = 300;
...
//    private static final int upperLimit = 17;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < howManyDifferentParameters; i++) {
            IdpProblemInitData idpProblemInitData = new IdpProblemInitData(numberCustomers[i], numberLinks[i], bandwidth, lowerLimit, upperLimit, optimizationCyclesNumber);
